            ...
            <div class="gap col-md-6">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <h3 class="mb-0">Vellore Institute of Technology, Vellore</h3>
                ...
                <div class="d-flex align-self-center col-auto d-none d-lg-block">
            ...
            <div class="gap col-md-6">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <h3 class="mb-0">Delhi Public School, Agra</h3>
                  <div class="mb-1 text-muted">2013-14 | 2015-16</div>
                  <p class="mb-auto">
                    Completed my X & Xll with CGPA - 8.8 and 90% respectively in
                    Physics, Chemistry & Maths with Physical Education
                  </p>
                </div>
                <div class="d-flex align-self-center col-auto d-none d-lg-block">
                  <img src="/Images/dps.png" alt="" className="h-100 w-90" />
                </div>
              </div>
            </div>
          </div>
